...
python /workspace/new/code/train.py   /workspace/code/data/train   /workspace/code/data/train_labels.csv
- 
- 
- 
  
  python  /workspace/new/code/predict.py   /workspace/new/model/dataset/test /workspace/new/results/submission.csv

python ./code/predict.py ./test ./results/submission.csv

docker run -it --gpus all -v D:/code/Flower-Recognition:/workspace registry.cn-chengdu.aliyuncs.com/mdl_base_dev/ubuntu20.04_cuda11.3.1_cudnn8_python3.8:cuda12.1_cudnn9_torch2.2_tf2.12_mmcv2.1_mmdet3.3_transformers4.39 /bin/bash
